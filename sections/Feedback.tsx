      ...
      >
        ...
        >
          ...
          <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">
            &quot;With the development of today&apos;s technology, Carbon Corp
            is very useful for today&apos;s work, or can be called Web 3.0. By
            using Carbon Corp, you can use it as anything!&quot;
          </p>
        </motion.div>
        <motion.div
